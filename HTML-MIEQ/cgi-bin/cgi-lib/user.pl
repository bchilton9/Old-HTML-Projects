...
<TABLE cellpadding="2" cellspacing="2" border="0" WIDTH="75%">
  ...
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=viewprofile&username=$username">$nav{'017'}</a></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editemail&username=$username">Edit E-Mail Address</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editpassword&username=$username">Change Password</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editprofile2&username=$username">$nav{'161'}</a></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editoptions&username=$username">Member Options</A></TD>
  </TR>

  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editsig&username=$username">Edit Signature/Member Pic</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$cgi?action=im">$nav{'102'} ($mnum)</a></TD>
  </TR>
...
<a href="index.cgi?action=anonemail&sendto=$info{'username'}" onMouseOver="stm(Text[1],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/email.gif" alt="Send an e-mail to $info{'username'}" border="0"></a>

<a href="index.cgi?action=imsend&to=$info{'username'}" onMouseOver="stm(Text[3],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/message.gif" alt="Send a message to $info{'username'}" border="0"></a>

~;

if ($access[19] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[23] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[25] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[26] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }

else {
         if ($info{'username'} eq $username) { print qq~<a href="$cgi?action=editprofile2&username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~;
         }
}
...
print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~;
         }
elsif ($access[23] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[25] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[26] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.mieq.net/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
