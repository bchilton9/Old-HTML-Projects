...
<TABLE cellpadding="2" cellspacing="2" border="0" WIDTH="50%">
  ...
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.mieq.net/cgi-bin/index.cgi?action=viewprofile&username=$info{'username'}">View $mymemsettings[1]'s Profile</A></TD>
  </TR>
~;
if ($access[19] eq "on") {
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.mieq.net/cgi-bin/index.cgi?action=admineditprofile&username=$info{'username'}">Edit $mymemsettings[1]'s Profile</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.mieq.net/cgi-bin/index.cgi?action=admineditemail&username=$info{'username'}">Edit $mymemsettings[1]'s E-Mail Address</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.mieq.net/cgi-bin/index.cgi?action=admineditpassword&username=$info{'username'}">Change $mymemsettings[1]'s Password</A></TD>
  </TR>
~;
}
if ($access[25] eq "on") {
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.mieq.net/cgi-bin/index.cgi?action=admineditrankstatus&username=$info{'username'}">Change $mymemsettings[1]'s Rank</A></TD>
  </TR>
~;
}
if ($access[23] eq "on") {
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.mieq.net/cgi-bin/index.cgi?action=admineditaccess&username=$info{'username'}">Change $mymemsettings[1]'s Access</A></TD>
  </TR>
~;
}
...
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.mieq.net/cgi-bin/index.cgi?action=viewlog&username=$info{'username'}">View $mymemsettings[1]'s Log File</A></TD>
  </TR>
~;
}
...
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.mieq.net/themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="javascript:killEntry('index.cgi?action=admindeleteprofile&deleteduser=$info{'username'}')">Delete $mymemsettings[1]</A></TD>
  </TR>
~;
}
print qq~
