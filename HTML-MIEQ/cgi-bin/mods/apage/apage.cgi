#!/usr/bin/perl -w
$| = 1; # CollapsedSubs: view_the_files  edit_htm_file  edit_txt_file  fix_the_txt_file  save_txt_file  save_htm_file  view_htm_file  read_the_readme  view_txt_file  delete_the_folder  delete_the_file  rename_the_file  add_the_file  creat_a_dir  save_a_dir  renamed_the_file  new_the_file  manage_the_pictures  delete_the_image  aset_the_settings  apage_menu_bar
...
if ($access[7] ne "on") { error("$err{'011'}"); }
}
