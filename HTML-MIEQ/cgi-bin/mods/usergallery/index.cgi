...
#17 - editalbum
#18 - deletealbum
#if ($access[7] eq "on") { error("$err{'011'}"); }
...
if ($access[18] eq "on") {
print qq~<a href="$usergalleryurl/index.cgi?action=removealbum&album=$item[0]">
<img src="$usergallerygfxurl/deletealbum.gif" border="0" width="16" height="13" alt="$ug{'006'}"></a>
~;
}
#}
...
#checkaccess(create);
if ($access[15] ne "on") { error("$err{'011'}"); }
...
#if ($settings[7] eq "Administrator") {
print qq~<tr><td><hr width="200"></td></tr><tr><td align="center">~;
...
#18 - deletealbum
if ($access[16] eq "on") { 
print qq~<a href="$usergalleryurl/index.cgi?action=addpicture&amp;album=$info{'album'}" class="smallnewslink">$ug{'004'}</a>&nbsp;-&nbsp;~;
}


if ($access[17] eq "on") { 
print qq~<a href="$usergalleryurl/index.cgi?action=editalbum&album=$info{'album'}" class="smallnewslink">$ug{'005'}</a>&nbsp;-&nbsp;~;
}


if ($access[18] eq "on") { 
print qq~<a href="$usergalleryurl/index.cgi?action=removealbum&album=$info{'album'}" class="smallnewslink">$ug{'006'}</a>~;
}
...
#17 - editalbum
#18 - deletealbum
if ($access[16] ne "on") { error("$err{'011'}"); }
