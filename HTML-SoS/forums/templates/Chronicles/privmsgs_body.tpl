  ...
  <tr> 
	...
	<td align="right"> 
	  ...
	  <table width="175" cellspacing="1" cellpadding="2" border="0" class="bodyline">
		<tr> 
		  <td colspan="3" width="100%" class="row1" nowrap="nowrap"><span class="gentblsmall">{BOX_SIZE_STATUS}</span></td>
		</tr>
		<tr> 
		  <td colspan="3" width="100%" class="row2">
			...
			<table cellspacing="0" cellpadding="0" border="0">
			  <tr> 
				...
				<td><img src="templates/Chronicles/images/voting_bar.gif" width="{INBOX_LIMIT_IMG_WIDTH}" alt="" height="12" /></td>
...
-->
		...
		<tr> 
		  <td width="33%" class="row1"><span class="gentblsmall">0%</span></td>
		  <td width="34%" align="center" class="row1"><span class="gentblsmall">50%</span></td>
		  <td width="33%" align="right" class="row1"><span class="gentblsmall">100%</span></td>
		</tr>
	  </table>
...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<!-- BEGIN listrow -->
	<tr> 
	  <td class="{listrow.ROW_CLASS}" width="5%" align="center" valign="middle"><img src="{listrow.PRIVMSG_FOLDER_IMG}" width="35" height="19" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" /></td>
