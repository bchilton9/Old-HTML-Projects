...
<form action="{S_GROUP_ACTION}" method="post" name="post"><table border="0" cellpadding="3" cellspacing="1" class="forumline" align="center">
	...
	<tr>
	  <td class="row1" colspan="2"><span class="gentblsmall">{L_ITEMS_REQUIRED}</span></td>
	</tr>
	<tr> 
	  <td class="row1" width="38%"><span class="gentbl">{L_GROUP_NAME}:</span></td>
	  <td class="row2" width="62%"> 
		<input type="text" name="group_name" size="35" maxlength="40" value="{GROUP_NAME}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1" width="38%"><span class="gentbl">{L_GROUP_DESCRIPTION}:</span></td>
	  <td class="row2" width="62%"> 
		<textarea name="group_description" rows=5 cols=51>{GROUP_DESCRIPTION}</textarea>
	  </td>
	</tr>
	<tr> 
	  <td class="row1" width="38%"><span class="gentbl">{L_GROUP_MODERATOR}:</span></td>
	...
	<tr> 
	  <td class="row1" width="38%"><span class="gentbl">{L_GROUP_STATUS}:</span></td>
	  <td class="row2" width="62%"> 
	...
	<!-- BEGIN group_edit -->
	<tr> 
	  <td class="row1" width="38%"><span class="gentbl">{L_DELETE_MODERATOR}</span>
	  <br />
	  <span class="gentblsmall">{L_DELETE_MODERATOR_EXPLAIN}</span></td>
	  <td class="row2" width="62%"> 
		<input type="checkbox" name="delete_old_moderator" value="1">
		{L_YES}</td>
	</tr>
	<tr> 
	  <td class="row1" width="38%"><span class="gentbl">{L_GROUP_DELETE}:</span></td>
	  <td class="row2" width="62%"> 
