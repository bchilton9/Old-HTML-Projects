...
<form method="post" action="{S_SPLIT_ACTION}">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="row2" colspan="3" align="center"><span class="gentblsmall">{L_SPLIT_TOPIC_EXPLAIN}</span></td>
	</tr>
	<tr> 
	  <td class="row1" nowrap="nowrap"><span class="gentbl">{L_SPLIT_SUBJECT}</span></td>
	...
	<tr> 
	  <td class="row1" nowrap="nowrap"><span class="gentbl">{L_SPLIT_FORUM}</span></td>
	...
	<tr> 
	  ...
	  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle"><img src="templates/Chronicles/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
