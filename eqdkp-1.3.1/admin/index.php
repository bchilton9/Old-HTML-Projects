...
else
{
    ...
    $admin_menu = array(
        'events' => array(
            ...
            2 => array('link' => 'listevents.php' . $SID, 'text' => $user->lang['list'], 'check' => 'a_event_')
        ),
        'groupadj' => array(
            0 => $user->lang['group_adjustments'],
            1 => array('link' => 'addadj.php' . $SID,  'text' => $user->lang['add'],  'check' => 'a_groupadj_add'),
            2 => array('link' => 'listadj.php' . $SID, 'text' => $user->lang['list'], 'check' => 'a_groupadj_')
        ),
        'indivadj' => array(
            0 => $user->lang['individual_adjustments'],
            1 => array('link' => 'addiadj.php' . $SID,                                      'text' => $user->lang['add'],  'check' => 'a_indivadj_add'),
            2 => array('link' => 'listadj.php' . $SID . '&amp;' . URI_PAGE . '=individual', 'text' => $user->lang['list'], 'check' => 'a_indivadj_')
        ),
        'items' => array(
            0 => $user->lang['items'],
            1 => array('link' => 'additem.php' . $SID,   'text' => $user->lang['add'],  'check' => 'a_item_add'),
            2 => array('link' => 'listitems.php' . $SID, 'text' => $user->lang['list'], 'check' => 'a_item_')
        ),
        'mysql' => array(
            0 => $user->lang['mysql'],
            1 => array('link' => 'mysql_info.php' . $SID, 'text' => $user->lang['mysql_info'], 'check' => '')
        ),
        'news' => array(
            0 => $user->lang['news'],
            1 => array('link' => 'addnews.php' . $SID,  'text' => $user->lang['add'],  'check' => 'a_news_add'),
            2 => array('link' => 'listnews.php' . $SID, 'text' => $user->lang['list'], 'check' => 'a_news_')
        ),
        'raids' => array(
            0 => $user->lang['raids'],
            1 => array('link' => 'addraid.php' . $SID,   'text' => $user->lang['add'],  'check' => 'a_raid_add'),
            2 => array('link' => 'listraids.php' . $SID, 'text' => $user->lang['list'], 'check' => 'a_raid_'),
            3 => array('link' => 'lua.php' . $SID,   'text' => $user->lang['lua_parse'],  'check' => 'a_lua_import')
        ),
        'turnin' => array(
            0 => $user->lang['turn_ins'],
            1 => array('link' => 'addturnin.php' . $SID, 'text' => $user->lang['add'], 'check' => 'a_turnin_add')
        ),
        'general' => array(
            0 => $user->lang['general_admin'],
            1 => array('link' => 'config.php' . $SID,         'text' => $user->lang['configuration'],  'check' => 'a_config_man'),
            2 => array('link' => 'manage_members.php' . $SID, 'text' => $user->lang['manage_members'], 'check' => 'a_members_man'),
            3 => array('link' => 'plugins.php' . $SID,        'text' => $user->lang['manage_plugins'], 'check' => 'a_plugins_man'),
            4 => array('link' => 'manage_users.php' . $SID,   'text' => $user->lang['manage_users'],   'check' => 'a_users_man'),
            5 => array('link' => 'logs.php' . $SID,           'text' => $user->lang['view_logs'],      'check' => 'a_logs_view')
        ),
        'styles' => array(
            0 => $user->lang['styles'],
            1 => array('link' => 'styles.php' . $SID . '&amp;mode=create', 'text' => $user->lang['create'], 'check' => 'a_styles_man'),
            2 => array('link' => 'styles.php' . $SID,                      'text' => $user->lang['manage'], 'check' => 'a_styles_man')
        )
    );
