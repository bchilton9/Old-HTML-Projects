...
check_access(editlink); if ($access_granted eq "1") {
...
#############
	...
	print_top();
	print qq~<form method="post" action="$cgi?action=addlink2">
...
sub addlink2 {
##############
	if ($adminonlyl eq "1") {check_access(editlink); if ($access_granted ne "1") { error("$err{'011'}"); }}
...
<tr>
<td valign="top"><form action="$cgi?action=editlinks2\&cat=$info{'cat'}\&id=$info{'id'}" method="post">
<td>
</tr>
<tr>
...
$filetoopen = "$info{'cat'}.dat";
	...
	print qq~<table border="0" width="100%" cellpading="0" cellspacing="0">
<tr>
<td valign="top"><form action="$cgi?action=deletelinks2\&cat=$info{'cat'}\&id=$info{'id'}" method="post">
<td>
</tr>
<tr>
...
$filetoopen = "$info{'cat'}.dat";
	...
	print qq~<table border="0" width="100%" cellpading="0" cellspacing="0">
<tr>
<td valign="top"><form action="$cgi?action=movelinks2\&cat=$info{'cat'}\&id=$info{'id'}" method="post">
<td>
</tr>
<tr>
...
$filetoopen = "$info{'cat'}.dat";
	...
	print qq~<table border="0" width="100%" cellpading="0" cellspacing="0">
<tr>
<td valign="top"><form action="$cgi?action=ratelinks2\&cat=$info{'cat'}\&id=$info{'id'}" method="post">
<td>
</tr>
<tr>
