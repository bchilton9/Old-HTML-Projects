...
<tr>
<td width="90%" class="statstext"><img src="$imagesurl/forum/open.gif" align="absmiddle" alt="">&nbsp;$msg{'170'} </td>
<td width="10%" class="statstextbold">$dlcount</td>
</tr>
<tr>
<td width="90%" class="statstext"><img src="$imagesurl/stats/scriptver.gif" align="absmiddle" alt="">&nbsp;$msg{'083'} </td>
<td width="10%" class="statstextbold">$scriptver</td>
</tr>
</table>
	</td>
</tr>
