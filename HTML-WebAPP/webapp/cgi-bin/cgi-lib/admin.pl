...
check_access();
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=siteconfig">$mnu{'001'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'001'}<br>~;}  
 
check_access(editwelc);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=welcomemsg">$mnu{'002'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'002'}<br>~;}  

check_access();
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=agreement">$mnu{'044'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'044'}<br>~;}  

check_access(editabout);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=aboutinfo">$mnu{'039'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'039'}<br>~;}  
 
if ($welcome_im eq "0") { print qq~$mnu{'003'} ($msg{'192'})<br>~; }
else { check_access(editim);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=welcomeim">$mnu{'003'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'003'}<br>~;}  
}

check_access();
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/language/view.cgi">$mnu{'043'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'043'}<br>~;}
 
check_access();
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/themes/view.cgi">$mnu{'004'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'004'}<br>~;} 

if ($dispfrad eq "0") { print qq~$mnu{'005'} ($msg{'193'})<br>~; }
else { 
check_access(editbanner);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/banners/view.cgi">$mnu{'005'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'005'}<br>~;}
}
 
check_access(editfaq);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/help/view.cgi">$mnu{'040'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'040'}<br>~;} 
 
check_access(editdown);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/downloads/downloadadmin.cgi">$mnu{'006'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'006'}<br>~;} 
 
check_access(editlink);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/links/linksadmin.cgi">$mnu{'007'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'007'}<br>~;} 
 
check_access();
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/logs/view.cgi">$mnu{'010'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'010'}<br>~;} 

print qq~<br> 
<b>$nav{'064'}</b><br>~; 

check_access(modadmin);
if ($access_granted eq 1) {print qq~<a href="$scripturl/mods/modmanager.cgi">$mnu{'042'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'042'}<br>~;}
 
print qq~<br> 
<b>$nav{'062'}</a></b><br>~;

check_access();
if ($access_granted eq 1) {print qq~<a href="$admin&amp;op=userapproval">$msg{'644'}</a><br>~; $access_granted = 0;} else {print qq~$msg{'644'}<br>~;} 

check_access();
if ($access_granted eq 1) {print qq~<a href="$admin&amp;op=userranks">$mnu{'012'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'012'}<br>~;} 

check_access();
if ($access_granted eq 1) {print qq~<a href="$admin&amp;op=userstate">$mnu{'013'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'013'}<br>~;}
...
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=managecats">$mnu{'014'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'014'}<br>~;} 
 
check_access(editboards);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=manageboards">$mnu{'015'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'015'}<br>~;} 
 
check_access(editcensor);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=setcensor">$mnu{'016'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'016'}<br>~;} 

print qq~<br> 
<b>$nav{'044'}</b><br>~; 
 
check_access(editpoll);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=polladmin">$mnu{'017'}</a>~; $access_granted = 0;} else {print qq~$mnu{'017'}~;}  
if ($multiplevoting eq "1") { print qq~ ($msg{'194'})<br>~; } else { print qq~ ($msg{'195'})<br>~; } 
...
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=verifynews">$mnu{'018'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'018'}<br>~;}
 
check_access(editnews);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=modifynews">$mnu{'019'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'019'}<br>~;}
 
check_access(edittops);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=topicadmin">$mnu{'020'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'020'}<br>~;}
 
print qq~<br> 
<b>$nav{'063'}</b><br>~;
 
check_access(editlblk);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/blocks/left/view.cgi">$mnu{'021'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'021'}<br>~;} 

check_access(editrblk);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/blocks/right/view.cgi">$mnu{'022'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'022'}<br>~;} 

print qq~<br> 
<b>$mnu{'045'}</b><br>~; 
 
# if Newsletter Module is on ... 
if ($modulenl eq "1") { check_access(editnl);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=newsletter">$mnu{'024'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'024'}<br>~;} } 
else { print qq~$mnu{'024'} ($msg{'196'})<br>~; } 
 
print qq~<br> 
<b>$nav{'070'}</b><br>~;
 
check_access(editip);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=editbanip">$mnu{'025'}</a><br>~; $access_granted = 0;} else {print qq~$mnu{'025'}<br>~;} 

print qq~<br> 
<b>$nav{'163'}</b><br>~;

check_access();
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=installupgrade">$nav{'164'}</a><br>~; $access_granted = 0;} else {print qq~$nav{'164'}<br>~;} 
...
sub welcomemsg { 
################ 
	check_access(editwelc); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
sub aboutinfo { 
################ 
check_access(editabout); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
sub welcomeim { 
################ 
	check_access(editim); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
sub manageboards { 
################## 
	check_access(editboards); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
sub setcensor { 
############### 
	check_access(editcensor); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
if ($subject eq "$info{'mysubject'}") { 
	...
	open(FILE2,">$topicsdir/$input{'cat'}.cat"); 
	lock(FILE2); print FILE2 "$postnum|$subj|$input{'posternick'}|$input{'postername'}|$input{'posteremail'}|$date|0|0\n"; 
	print FILE2 @data2; 
	close(FILE2); 
...
sub modifynews { 
################ 
	check_access(editnews); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
sub topicadmin { 
################ 
	check_access(edittops); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
check_access(editip); if ($access_granted ne "1") { error("$err{'011'}"); } 
...
#  print $test[0]; 
 ...
 <center><b>$msg{'224'}</b></center><p> 
  ...
  foreach (@data) { 
	...
	print qq ~ 
  <form action="$pageurl/$admin&amp;op=addbannedip" method="post"> 
  <tr> 
