...
<tr><td bgcolor='#F2C973'><font size='2'>$msg{'354'}</font></td><td bgcolor='#F2C973'><font size='2'>$msg{'355'}</font></td><td bgcolor='#F2C973'><font size='2'>$msg{'356'}</font></td><td bgcolor='#F2C973'><font size='2'>$msg{'357'}</font></td></tr>~;

foreach $dldrec (@downloadsdatabase){
	chomp($dldrec);
	($download,$file,$desc)=split(/\|/,$dldrec);
	print qq~<tr><td><font size="2"><a href="$pageurl/admin/downloads/downloadadmin.cgi?action=editdlcat&amp;file=$file">$nav{'096'}</a> - <a href="$pageurl/admin/downloads/downloadadmin.cgi?action=deletedlcat&amp;file=$file">$nav{'097'}</a></font></td><td><font size="2">$download</font></td><td><font size="2">$file</font></td><td><font size="2">$desc</font></td></tr>~;
}

print qq~</table><p><a href="$pageurl/admin/downloads/downloadadmin.cgi?action=adddlcat">$nav{'125'}</a></p></font>~;
...
<i>$nav{'125'}</i><br>
<form action='$pageurl/admin/downloads/downloadadmin.cgi?action=adddlcat2' method='post'>
<table border='1'>
<tr><td><font size='2'>$msg{'355'}</font></td><td><input type='text' name='ncatname'></td></tr>
...
print "Location: $pageurl/admin/downloads/downloadadmin.cgi\n\n"; 
exit;
...
print qq~<font face='Arial'>
<i>$nav{'126'}</i><br>
<form action="$pageurl/admin/downloads/downloadadmin.cgi?action=editdlcat2" method="post">
<table border='1'>
<tr><td><font size='2'>$msg{'355'}</font></td><td><input type='text' name='ncatname' value="$ecatname"></td></tr>
...
close (DATABASE);
	...
	<a href="$pageurl/admin/downloads/downloadadmin.cgi?action=deletedlcat2&amp;file=$dcatfile">$nav{'047'}</a> - <a href="$pageurl/admin/downloads/downloadadmin.cgi">$nav{'048'}</a>~;
