...
<table border='1'>
<tr><td><font size='2'>$msg{'368'}</font></td><td><input type='text' name='nthemes'></td><td>$msg{'550'}</td></tr>
<tr><td><font size='2'>$msg{'356'}</font></td><td><input type='text' name='ndir'></td><td>$msg{'551'}</td></tr>
<tr><td><font size='2'>$msg{'351'}</font></td><td><input type='text' name='nstatus'></td><td>$msg{'552'}</td></tr>
</table>
<input type='Submit' value='$btn{'037'}'>
</form>
</font>
</font>
";
