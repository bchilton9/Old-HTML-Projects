...
<i>$nav{'128'}</i><br>
<form action='$pageurl/admin/links/linksadmin.cgi?action=addlncat2' method='post'>
<table border='1'>
...
print qq~<font face='Arial'>
<i>$nav{'129'}</i><br>
<form action="$pageurl/admin/links/linksadmin.cgi?action=editlncat2" method="post">
<table border='1'>
