...
if ( $lang_extend_admin )
{
	...
	$lang['PCP_field_image_explain'] = 'Renseignez ici une URI (URL locale) ou une clé du tableau $image[] (see <i>votre_template</i>/<i>votre_template</i>.cfg).';
	...
	$lang['PCP_field_deleted'] = 'La définition de la zone a été supprimée.<br /><br />Cliqez %sici%s pour retourner à la liste des zones.';
