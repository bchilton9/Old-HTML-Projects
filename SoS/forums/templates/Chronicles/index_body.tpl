...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	<td class="row1" align="center" valign="middle" rowspan="2"><img src="templates/Chronicles/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" /></td>
...
<form method="post" action="{S_LOGIN_ACTION}">
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="row1" align="center" valign="middle" height="28"><span class="gentblsmall">{L_USERNAME}: 
...
<table cellspacing="0" border="0" align="center" cellpadding="1" bgcolor="#000000">
	...
	<table cellspacing="3" border="0" align="center" background="templates/Chronicles/images/gen_background.jpg">
	  <tr> 
		<td width="20" align="center"><img src="templates/Chronicles/images/folder_new_big.gif" alt="{L_NEW_POSTS}"/></td>
		<td><span class="gentblsmall">{L_NEW_POSTS}</span></td>
		<td>&nbsp;&nbsp;</td>
		<td width="20" align="center"><img src="templates/Chronicles/images/folder_big.gif" alt="{L_NO_NEW_POSTS}" /></td>
		<td><span class="gentblsmall">{L_NO_NEW_POSTS}</span></td>
		<td>&nbsp;&nbsp;</td>
		<td width="20" align="center"><img src="templates/Chronicles/images/folder_locked_big.gif" alt="{L_FORUM_LOCKED}" /></td>
