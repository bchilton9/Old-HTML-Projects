...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  <td class="row1"><span class="gentbl">{L_SIGNATURE}</span><br />
		<span class="gentblsmall">{L_SIGNATURE_EXPLAIN}<br />
		<br />
		{HTML_STATUS}<br />
		{BBCODE_STATUS}<br />
	...
	<tr> 
	  <td class="row1"><span class="gentbl">{L_NOTIFY_ON_REPLY}</span></td>
	  <td class="row2"> 
	...
	<tr> 
	  <td class="row1"><span class="gentbl">{L_POPUP_ON_PRIVMSG}</span></td>
	  <td class="row2"> 
	  ...
	  <td class="row1" colspan="2"> 
		<table width="70%" cellspacing="2" cellpadding="0" border="0">
		  <tr> 
			...
			<td align="center"><span class="gentblsmall">{L_CURRENT_IMAGE}</span><br />
			  {AVATAR}<br />
			  <input type="checkbox" name="avatardel" />
			  &nbsp;<span class="gentblsmall">{L_DELETE_AVATAR}</span></td>
		  </tr>
		</table>
	  </td>
	</tr>
	...
	<tr> 
	  <td class="row1"><span class="gentbl">{L_UPLOAD_AVATAR_URL}</span></td>
	  <td class="row2"> 
	...
	<tr> 
	  <td class="row1"><span class="gentbl">{L_LINK_REMOTE_AVATAR}</span></td>
	  <td class="row2"> 
	...
	<tr>
	  <td class="row1" colspan="2"><span class="gentblsmall">{L_SPECIAL_EXPLAIN}</span></td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gentbl">{L_USER_ACTIVE}</span></td>
	  <td class="row2"> 
	...
	<tr> 
	  <td class="row1"><span class="gentbl">{L_ALLOW_PM}</span></td>
	  <td class="row2"> 
	...
	<tr> 
	  <td class="row1"><span class="gentbl">{L_ALLOW_AVATAR}</span></td>
	  <td class="row2"> 
	...
	<tr>
		<td class="row1"><span class="gentbl">{L_SELECT_RANK}</span></td>
		<td class="row2"><select name="user_rank">{RANK_SELECT_BOX}</select></td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gentbl">{L_DELETE_USER}?</span></td>
	  <td class="row2"> 
