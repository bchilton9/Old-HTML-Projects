...
<form method="post" action="{S_BANLIST_ACTION}"><table width="80%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  <td class="row1">{L_USERNAME}: <br /><span class="gentblsmall">{L_BAN_USER_EXPLAIN}</span></td>
	...
	<tr> 
	  <td class="row1">{L_USERNAME}: <br /><span class="gentblsmall">{L_UNBAN_USER_EXPLAIN}</span></td>
	...
	<tr> 
	  <td class="row1">{L_IP_OR_HOSTNAME}: <br /><span class="gentblsmall">{L_BAN_IP_EXPLAIN}</span></td>
	...
	<tr> 
	  <td class="row1">{L_IP_OR_HOSTNAME}: <br /><span class="gentblsmall">{L_UNBAN_IP_EXPLAIN}</span></td>
	...
	<tr> 
	  <td class="row1">{L_EMAIL_ADDRESS}: <br /><span class="gentblsmall">{L_BAN_EMAIL_EXPLAIN}</span></td>
	...
	<tr> 
	  <td class="row1">{L_EMAIL_ADDRESS}: <br /><span class="gentblsmall">{L_UNBAN_EMAIL_EXPLAIN}</span></td>
