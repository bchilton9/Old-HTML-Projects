...
check_access();
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=siteconfig">$mnu{'001'}</a><br>~; $access_granted = 0;} 
 
check_access(editwelc);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=welcomemsg">$mnu{'002'}</a><br>~; $access_granted = 0;} 

################### Added for bigmike's welcome message hack ##############################
check_access(editwelc);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=guestwelcomemsg">Edit Guest Welcome message</a><br>~; $access_granted = 0;} else {print qq~Edit Guest Welcome message<br>~;}  
################### End bigmike's welcome message hack ##############################

check_access();
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=agreement">$mnu{'044'}</a><br>~; $access_granted = 0;}

if ($welcome_im eq "0") { print qq~$mnu{'003'}<br>~; }
else { check_access(editim);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=welcomeim">$mnu{'003'}</a><br>~; $access_granted = 0;} 
}

check_access(editlink);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/links/linksadmin.cgi">$mnu{'007'}</a><br>~; $access_granted = 0;} 
 
check_access(modadmin);
if ($access_granted eq 1) {print qq~<a href="$scripturl/mods/modmanager.cgi">$mnu{'042'}</a><br>~; $access_granted = 0;} 


print qq~
<A HREF="$pageurl/mods/menuman/admin/admin.cgi">Edit Menus</A><BR>
<A HREF="$pageurl/mods/apage/apage.cgi">Page Admin</A><BR>
~;

check_access(editlblk);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/blocks/left/view.cgi">$mnu{'021'}</a><br>~; $access_granted = 0;} 

check_access(editrblk);
if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/blocks/right/view.cgi">$mnu{'022'}</a><br>~; $access_granted = 0;} 
...
#if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=newsletter">$mnu{'024'}</a><br>~; $access_granted = 0;} 
#else { print qq~$mnu{'024'} ($msg{'196'})<br>~; } 

#check_access(editabout);
#if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=aboutinfo">$mnu{'039'}</a><br>~; $access_granted = 0;}

#check_access();
#if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/logs/view.cgi">$mnu{'010'}</a><br>~; $access_granted = 0;} 


#check_access();
#if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/language/view.cgi">$mnu{'043'}</a><br>~; $access_granted = 0;} 
 
#check_access();
#if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/themes/view.cgi">$mnu{'004'}</a><br>~; $access_granted = 0;} 

#if ($dispfrad eq "0") { print qq~$mnu{'005'} ($msg{'193'})<br>~; }
#else { 
#check_access(editbanner);
#if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/banners/view.cgi">$mnu{'005'}</a><br>~; $access_granted = 0;} 
#}
 
#check_access(editfaq);
#if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/help/view.cgi">$mnu{'040'}</a><br>~; $access_granted = 0;}  
 
#check_access(editdown);
#if ($access_granted eq 1) {print qq~<a href="$scripturl/admin/downloads/downloadadmin.cgi">$mnu{'006'}</a><br>~; $access_granted = 0;}  
...
check_access(editip);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=editbanip">$mnu{'025'}</a><br>~; $access_granted = 0;} 
...
check_access();
if ($access_granted eq 1) {print qq~<a href="$admin&amp;op=userranks">$mnu{'012'}</a><br>~; $access_granted = 0;} 
check_access();
if ($access_granted eq 1) {print qq~<a href="$admin&amp;op=userstate">$mnu{'013'}</a><br>~; $access_granted = 0;} 
...
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=managecats">$mnu{'014'}</a><br>~; $access_granted = 0;} 
 
check_access(editboards);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=manageboards">$mnu{'015'}</a><br>~; $access_granted = 0;} 
 
check_access(editcensor);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=setcensor">$mnu{'016'}</a><br>~; $access_granted = 0;} 
...
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=polladmin">$mnu{'017'}</a>~; $access_granted = 0;}   
...
print qq~ 
  ...
  <TR>
    ...
    <TD><HR COLOR=blue><B>Gallery Admin</B><BR>
	<HR COLOR=blue>
    </TD>
    <TD></TD>
  </TR>
...
<a href="$pageurl/index.cgi?action=postnews">Add News</A><BR>

~;
 
#check_access(pubnews);
#if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=verifynews">$mnu{'018'}</a><br>~; $access_granted = 0;} 

check_access(editnews);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=modifynews">$mnu{'019'}</a><br>~; $access_granted = 0;} 
 
check_access(edittops);
if ($access_granted eq 1) {print qq~<a href="$pageurl/$admin&amp;op=topicadmin">$mnu{'020'}</a><br>~; $access_granted = 0;} 
 
print qq~

</TD>
    <TD VALIGN="Top">
<A HREF="$pageurl/mods/usergallery/admin/admin.cgi">Gallery Admin</A>
</TD>
    <TD VALIGN="Top">
...
~; 
		foreach $curboard (@catinfo) { 
			if ($curboard ne "$catinfo[0]" && $curboard ne "$catinfo[1]") { 
				...
				print qq~<tr> 
<td valign="top"><form  onSubmit="submitonce(this)"   onSubmit="submitonce(this)"  action="$pageurl/$admin&amp;op=modifyboard" method="post"> 
...
$temp = "DELETE FROM flagging WHERE name= '$deleteduser' LIMIT 1"; 
