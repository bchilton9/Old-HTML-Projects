...
<TABLE cellpadding="2" cellspacing="2" border="0" WIDTH="75%">
  ...
  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=viewprofile&username=$username">$nav{'017'}</a></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editemail&username=$username">Edit E-Mail Address</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editpassword&username=$username">Change Password</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editprofile2&username=$username">$nav{'161'}</a></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editoptions&username=$username">Member Options</A></TD>
  </TR>

  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editmagelo&username=$username">Edit Magelo</A></TD>
  </TR>

  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editsig&username=$username">Edit Signature/Member Pic</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/mods/flagging/flagging.cgi?do=editflagging">Edit Flagging</a></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://207.36.208.139/freefire.us/themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$cgi?action=im">$nav{'102'} ($mnum)</a></TD>
  </TR>
...
<table border="0">
<tr>
<td class="formstexttitle" colspan="2">Edit Magelo</td>


<tr>
<tr>
<td colspan="2">
<FONT COLOR=RED><B>Put the FULL address to your magelo profile in or it will not work.<BR>
(EXP: http://www.magelo.com/eq_view_profile.html?num=0000000).</B></FONT><BR>
If you do not have a Magelo profile please signup for one at <A HREF=http://www.magelo.com>Magelo.com</A>. It is Free!
</td>
<tr>
<table border="0" cellspacing="0">
<tr>
<td class="formstextnormal" width="30%">Magelo URL:</td>
<td class="formstext" width="70%"><input type="text" name="yahoo" size="60" value="$memsettings[24]"></td>
</tr>
</TABLE>
</tr>
<input type="hidden" name="passwrd1" size="20" value="$memsettings[0]">
...
<tr>
<td class="formstexttitle" colspan="2">Rank Settings</td>
</TR>
<TR>
...
if ($memsettings[7] eq "Administrator") {print qq~

<tr>
<td colspan="2">&nbsp;</td>
</tr>
<tr>
<td class="formstexttitle" colspan="2">Broadcast Message</td>
</TR>
...
<TD>
<div align=right>
<a href="$pageurl/$cgi?action=blistedit&buddy=$info{'username'}"><img src="$imagesurl/buddy/guest.gif" border=0 alt="Add $info{'username'} to Buddy List"></a>

<a href="index.cgi?action=anonemail&sendto=$info{'username'}"><img src="http://207.36.208.139/freefire.us/images/forum/email.gif" alt="Send an e-mail to $info{'username'}" border="0"></a>

<a href="index.cgi?action=imsend&to=$info{'username'}"><img src="http://207.36.208.139/freefire.us/images/forum/message.gif" alt="Send a message to $info{'username'}" border="0"></a>

~;

if ($settings[7] eq "Administrator") { # && $info{'username'} ne $username
print qq~<a href="$cgi?action=admineditprofile&amp;username=$info{'username'}" class="formslink"><img src="http://207.36.208.139/freefire.us/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~;
	 } 

else {
	 if ($info{'username'} eq $username) { print qq~<a href="$cgi?action=editprofile2&username=$info{'username'}" class="formslink"><img src="http://207.36.208.139/freefire.us/images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~;
	 }
}
...
<tr>
<td class="forumwindow3" width="25%" nowrap>Flaging:</td>
<td class="forumwindow1" width="75%" nowrap><A HREF="http://207.36.208.139/freefire.us/cgi-bin/mods/flagging/chart.cgi?show=$info{'username'}" onclick="NewWindow(this.href,'name','1000','310','yno');return false;">View My Flag's</A></td>
</tr>
