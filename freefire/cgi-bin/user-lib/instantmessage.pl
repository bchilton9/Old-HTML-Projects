...
sub messageadmin {
#############
if ($username ne "admin") { error("$err{'011'}  <br><Br><font color=red> imx version 0.7</font>"); }
...
<tr class=helpsnavtable><td><font color=orange><b>WebOffice $office_gen{'019'}</b></font></td></tr><tr class=forumwindow3><Td>
<input type="checkbox" value="on" name="office"$checked1>$msg{'299'}
<Br>

<table cellpadding="2" cellspacing="0" border=1 bordercolor=$prefthemecolor><tr><td>
<img src="$imagesurl/im/office/office_small.gif" border="0">
<img src="$imagesurl/im/office/calendar_small.gif" border="0">
<img src="$imagesurl/im/office/task_small.gif" border="0">
<img src="$imagesurl/im/office/journal_small.gif" border="0">
<img src="$imagesurl/im/office/contact_small.gif" border="0">
</td></tr></table>
<br>
</td></tr></table>
<br><br>
...
<br><small><i><b>
<A HREF="javascript:void()" onclick="window.open('http://www.iglesiadelpactorenacer.org/cgi-bin/index.cgi?action=quicklistedit', 'QuickList', 'height=200,width=300', false);">
$bud{'006'}</a></small></i></b>
   </td> 
  </tr>~;
...
<tr>
<td width="100%">
~;if ($icon ne "1"){print qq~
<img src="$imagesurl/im/$icon.gif">&nbsp; ~;}else{print qq~ 
...
exit;
	...
	open (FILE, ">$memberdir/backup/$username.msg");
	file_lock(FILE);
	print FILE "$username|$subject|$date|$message|$newmessageid|$recipient2|$icon\n";
	foreach $curm (@imessages) { print FILE "$curm"; }
	unfile_lock(FILE);
	close(FILE);}
...
#############
	...
	if ($input{'tag'} eq "on") {
	$tag = "<br>Encontremonos en <a href=http://www.iglesiadelpactorenacer.org/cgi-bin/mods/tagbox/tagbox.cgi target=_blank>Notas Instantaneas</a>";
	$message = "$message $tag";}
...
print qq~<option value="$pageurl/$cgi?action=messageadmin">IMX Admin</option>~;
}
print qq~
</select>
</form>
