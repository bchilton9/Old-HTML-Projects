...
<CENTER>
<img src="$themesurl/$usertheme/images/spin.jpg" alt="$pagename">
...
print qq~<table border="0" cellpadding="0" cellspacing="0" width="100%" class="navbar"$background> 
	    ...
	    <td width="20%" align="center">&nbsp;<a href="$pageurl/$cgi?action=forum&amp;board=" class="nav">$nav{'003'}</a>&nbsp;</td> 
			...
			<td width="20%" align="center">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/calendar/index.cgi?vsSD=1" class="nav">Calendar</a>&nbsp;</td> 
          </tr> 
        </table>~;
...
#######################
 ...
 print qq~<tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/calendar/index.cgi?vsSD=1" class="menu">Calendar</a></td>
 </tr>
 <tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/apage/apage.cgi?f=charter.html" class="menu">Charter/Rules</a></td>
 </tr>
 <tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/gallery/index.cgi" class="menu">Gallery</a></td>
 </tr>
 <tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/index.cgi?action=memberlist2" class="menu">Roster</a></td>
 </tr>
 <tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/bank/bank.cgi" class="menu">Guild Bank</a></td>
 </tr>
 <tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/flagging/chart.cgi" class="menu" onclick="NewWindow(this.href,'name','950','600','yes');return false;">Flagging</a></td>
 </tr>
 <tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/showhtml/showhtml.pl?url=www.eqguilded.com/freefire/cgi-bin/mods/chat/index.cgi" class="menu">Chat Room</a></td>
 </tr>
~;
...
boxheader("$pagename");
 ...
 print qq~<tr>
 <td class="cat"><img src="$themesurl/$usertheme/images/dot.gif">&nbsp;<a href="http://www.eqguilded.com/freefire/cgi-bin/mods/office/journal.cgi" class="menu">Journal</a></td>
 </tr>~;
