...
if ($letmemdel eq "1" && $info{'username'} ne "admin") {print qq~
...
print qq~<td class="forumwindow3" width="25%" nowrap>$msg{'027'}</td>
...
<td class="forumwindow1" width="25%">$msg{'024'}&nbsp;$ssettings7</td>~;
if ($ssettings11 ne "0") {print qq~<td class="forumwindow1" width="25%">$msg{'022'}&nbsp;<a href="$scripturl/$cgi?action=otherarticles&amp;writer=$info{'username'}&amp;real=$ssettings1">$ssettings11</a></td>~;}
else {print qq~<td class="forumwindow1" width="25%">$msg{'022'}&nbsp;$ssettings11</a></td>~; }
print qq~
<td class="forumwindow1" width="25%">$msg{'021'}&nbsp;$ssettings6</td>
<td class="forumwindow1" width="25%">$msg{'178'}:&nbsp;$ssettings14</td>
</tr><tr>~;
...
print qq~<td colspan="4" align="center" class="forumwindow1" width="50%">$ssettings1 $msg{'588'}  $tdmem $msg{'589'}</td>
</tr><tr>
...
<td class="forumwindow3" align="center" colspan="4" width="100%"><a href="$cgi?action=anonemail&sendto=$info{'username'}" class="formslink">$msg{'394'}</a></td>
</tr><tr>~;

if ( $ssettings8 eq "" &&  $ssettings23 eq "" && $ssettings24 eq "") {$msgspan1 = "4"; $msgwidth = "100%";}
if ( $ssettings8 ne "" &&  $ssettings23 eq "" && $ssettings24 eq "") {$msgspan1 = "3"; $msgspan2 = "1"; $msgwidth = "50%";}
if ( $ssettings8 eq "" &&  $ssettings23 ne "" && $ssettings24 eq "") {$msgspan1 = "3"; $msgspan2 = "1"; $msgwidth = "50%";}
if ( $ssettings8 eq "" &&  $ssettings23 ne "" && $ssettings24 eq "") {$msgspan1 = "3"; $msgspan2 = "1"; $msgwidth = "50%";}
if ( $ssettings8 eq "" &&  $ssettings23 eq "" && $ssettings24 ne "") {$msgspan1 = "2"; $msgspan2 = "1"; $msgwidth = "50%";}
if ( $ssettings8 ne "" &&  $ssettings23 ne "" && $ssettings24 eq "") {$msgspan1 = "2"; $msgspan2 = "1"; $msgwidth = "33%";}
if ( $ssettings8 ne "" &&  $ssettings23 eq "" && $ssettings24 ne "") {$msgspan1 = "2"; $msgspan2 = "1"; $msgwidth = "33%";}
if ( $ssettings8 eq "" &&  $ssettings23 ne "" && $ssettings24 ne "") {$msgspan1 = "2"; $msgspan2 = "1"; $msgwidth = "33%";}
if ( $ssettings8 ne "" &&  $ssettings23 ne "" && $ssettings24 ne "") {$msgspan1 = "1"; $msgspan2 = "1"; $msgwidth = "25%";}

print qq~<td class="forumwindow3" align="center" colspan="$msgspan1" width="$msgwidth"><a href="$cgi?action=imsend&amp;to=$info{'username'}" class="formslink">$nav{'018'}</a></b></td>~;

if ( $ssettings8 ne "") {
print qq~
<td align="center" colspan="$msgspan2" class="forumwindow3" width="$msgwidth" nowrap><a href="http://www.icq.com/$ssettings8" target="_blank"><img src="http://web.icq.com/whitepages/online?icq=$ssettings8&img=5" alt="$msg{'052'} $ssettings1" border="0"></a></td>
~;}
if ( $ssettings23 ne "") {
print qq~
<td align="center" colspan="$msgspan2" class="forumwindow3"  width="$msgwidth" align="center"><a href="aim:goim?screenname=$ssettings23&amp;message=Hi.+Are+you+there?"><img src="$imagesurl/aimyel_im.gif" alt="$msg{'661'} $ssettings1" border="0"></a></td>
~;}
if ( $ssettings24 ne "") {
print qq~
<td align="center" colspan="$msgspan2" class="forumwindow3"  width="$msgwidth" align="center"><a href="http://edit.yahoo.com/config/send_webmesg?.target=$ssettings24&.src=pg"><img border="0" src="http://opi.yahoo.com/online?u=$ssettings24&m=g&t=1" alt="$msg{'662'} $ssettings1"></a></td>
~;}
print qq~
</tr><tr>
...
if ($username eq "admin" && $info{'username'} ne "admin") { print qq~<a href="$cgi?action=admineditprofile&amp;username=$info{'username'}" class="formslink">$nav{'161'}</a>~;
	 } else {
	 if ($info{'username'} eq $username) { print qq~<a href="$cgi?action=editprofile2&amp;username=$info{'username'}" class="formslink">$nav{'161'}</a>~;
	 }
}
