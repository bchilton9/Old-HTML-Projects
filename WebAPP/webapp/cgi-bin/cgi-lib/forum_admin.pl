...
<tr>
<td><form action="$forum$curboard&op=modifystickymessage2" method="post" name="creator">
...
foreach $curcat (@categories) {
	...
	print_top();
	print qq~<form action="$forum$curboard&op=movestickythread2&thread=$info{'thread'}" method="post">
