...
<tr>
<td><form action="$cgi?action=imsend2" method="post">
...
############
	...
	print qq~<table width="100%" border="0" cellspacing="0" cellpadding="1">
<tr>
<td><form action="$cgi?action=siteim2" method="post">
<input name="messageid" value="$mid" type="hidden">
<table border="0" cellspacing="1">
<tr>
<td><b>$msg{'059'}</b></td>
...
#############
	...
	print qq~<table width="100%" border="0" cellspacing="0" cellpadding="1">
<tr>
<td><form action="$cgi?action=adminim2" method="post">
<input name="messageid" value="$mid" type="hidden">
<table border="0" cellspacing="1">
<tr>
<td><b>$msg{'059'}</b></td>
...
###########
	...
	print qq~<table width="100%" border="0" cellspacing="0" cellpadding="1">
<tr>
<td><form action="$cgi?action=modim2" method="post">
<input name="messageid" value="$mid" type="hidden">
<table border="0" cellspacing="1">
<tr>
<td><b>$msg{'059'}</b></td>
