...
# subs.pl                                                                     #
# v0.9.9 - Requin                                                             #
# Date Formatting and undoubbc & undosmilies by: Floyd for v0.9.8             #
# Error Message Update by: Floyd for v0.9.8                                   #
#                                                                             #
...
##################
	require "$scriptdir/config.pl";
	require "$sourcedir/plugins.pl";
	require "$themesdir/$usertheme/pollfooter.pl";
}
