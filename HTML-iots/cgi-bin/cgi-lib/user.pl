...
<TABLE cellpadding="2" cellspacing="2" border="0" WIDTH="75%">
  <TR>
    <TD class="forumwindow2">&nbsp; &nbsp;Pick a Task:</TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=viewprofile&username=$username">$nav{'017'}</a></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editemail&username=$username">Edit E-Mail Address</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editpassword&username=$username">Change Password</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editprofile2&username=$username">$nav{'161'}</a></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editoptions&username=$username">Member Options</A></TD>
  </TR>

  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$pageurl/$cgi?action=editsig&username=$username">Edit Signature/Member Pic</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<a href="$cgi?action=im">$nav{'102'} ($mnum)</a></TD>
  </TR>
...
<TABLE BORDER=0 CELLPADDING="2" width=75%>
  <TR>
    <TD class="forumwindow2"><P ALIGN=Left>&nbsp; &nbsp;Buddy List:</TD>
  </TR>
  <TR>
...
<TD COLSPAN=2 VALIGN="Top" height="100%">
        ...
        <table cellpadding="3" cellspacing="3" width="100%" border="0"><tr>
        <td class="forumwindow2" valign="top" width="25%">$msg{'655'}</td>
        <td class="forumwindow1" valign="top" width="75%">$about</font></td></tr><tr>
        <td class="forumwindow2" valign="top" width="25%">$msg{'656'}</td>
...
print qq~
<IFRAME frameborder=2 style="height:605;width:805;scrolling:no;" class=iframe name=cwindow src='$memsettings[24]'></IFRAME>
<P>
...
<tr>
<td class="formstextnormal" width="30%">Magelo Profile:</td>
...
<a href="index.cgi?action=anonemail&sendto=$info{'username'}" onMouseOver="stm(Text[1],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/email.gif" alt="Send an e-mail to $info{'username'}" border="0"></a>

<a href="index.cgi?action=imsend&to=$info{'username'}" onMouseOver="stm(Text[3],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/message.gif" alt="Send a message to $info{'username'}" border="0"></a>

~;

if ($access[19] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[23] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[25] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[26] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }

else {
         if ($info{'username'} eq $username) { print qq~<a href="$cgi?action=editprofile2&username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~;
         }
}
...
<tr>
<td class="forumwindow2" width="25%" nowrap>Rank:</td>
...
<td class="forumwindow2" width="25%" nowrap>$msg{'027'}</td>
...
print qq~
<tr>
<td class="forumwindow2" width="25%" nowrap>ICQ:</td>
...
print qq~
<tr>
<td class="forumwindow2" width="25%" nowrap>AOL:</td>
<td class="forumwindow1" width="75%" nowrap>
...
print qq~
<tr>
<td class="forumwindow2" width="25%" nowrap>$msg{'021'}</td>
...
print qq~
<tr>
<td class="forumwindow2" width="25%" nowrap>$msg{'022'}</td>
<td class="forumwindow1" width="75%" nowrap>
...
print qq~
<tr>
<td class="forumwindow2" valign="top" width="25%">Info:</td>
...
if ($ssettings24 ne "") {
print qq~
<IFRAME frameborder=2 style="height:605;width:805;scrolling:no;" class=iframe name=cwindow src='$ssettings24'></IFRAME>
<P>
<A HREF=http://www.magelo.com TARGET=_new>Magelo Profile</A>
~;
}
...
print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~;
         }
elsif ($access[23] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[25] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
elsif ($access[26] eq "on") { print qq~<a href="$cgi?action=admineditmember&amp;username=$info{'username'}" class="formslink" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com//images/forum/modify.gif" alt="Edit $info{'username'}" border=0></a>~; }
