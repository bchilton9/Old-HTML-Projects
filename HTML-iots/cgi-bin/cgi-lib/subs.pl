...
################
     ...
     if ($username ne "$anonuser") {
           ...
           print qq~<tr>
<td class="whocat">$msg{'002'}<BR>'$sett[1]'<HR></td>
</tr>
<tr>
<td class="whocat">$msg{'342'}<a href="$pageurl/$cgi?action=im" class="whomenu">$mnum</a>$msg{'343'}<HR></td>
</tr>
~;
...
<a href="$pageurl/$cgi?action=who" class="whomenu"><u>$users</u></a>$msg{'347'}<HR></td>
</tr>~;
