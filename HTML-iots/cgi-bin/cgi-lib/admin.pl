...
<TABLE BORDER BGCOLOR="#00007D" CELLSPACING="0" CELLPADDING="2" WIDTH='70%"'>
  <TR>
    <TD BGCOLOR="#006400"><P ALIGN=Center>
      <B>Username</B></TD>
    <TD BGCOLOR="#006400"><P ALIGN=Center>
      <B>Ip Address</B></TD>
    <TD BGCOLOR="#006400"><P ALIGN=Center>
...
Options: Guild Leader, Officer, Member, Recruit.<BR>
Higher ranked groups will have access to lower fourms.<BR>
$msg{'203'}<br>
...
<tr>
<td bgcolor="#00007D"><b>$msg{'207'}</b></td>
<td bgcolor="#00007D"><b>$msg{'208'}</b></td>
~;
                foreach $line (@data) {
                        @item = split(/\|/, $line);
                        print qq~<tr>
<td bgcolor="#006400"><a href="$pageurl/$cgi?action=pollit2&amp;id=$item[$0]">$item[1]</a></td>
<td bgcolor="#006400">[<a href="$pageurl/$admin&amp;op=editpoll&amp;id=$item[$0]">$nav{'096'}</a>] <!-- [<a href="$admin&amp;op=deletepoll&amp;id=$item[$0]">$nav{'097'}</a>] [<a href="$admin&amp;op=resetpoll&amp;id=$item[$0]">$nav{'117'}</a>]--></td>
</tr>
~;
                }
                print qq~</table>
...
<TABLE cellpadding="2" cellspacing="2" border="0" WIDTH="50%">
  ...
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.impulseoftheshadows.com//cgi-bin/index.cgi?action=viewprofile&username=$info{'username'}">View $mymemsettings[1]'s Profile</A></TD>
  </TR>
~;
if ($access[19] eq "on") {
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.impulseoftheshadows.com//cgi-bin/index.cgi?action=admineditprofile&username=$info{'username'}">Edit $mymemsettings[1]'s Profile</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.impulseoftheshadows.com//cgi-bin/index.cgi?action=admineditemail&username=$info{'username'}">Edit $mymemsettings[1]'s E-Mail Address</A></TD>
  </TR>
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.impulseoftheshadows.com//cgi-bin/index.cgi?action=admineditpassword&username=$info{'username'}">Change $mymemsettings[1]'s Password</A></TD>
  </TR>
~;
}
if ($access[25] eq "on") {
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.impulseoftheshadows.com//cgi-bin/index.cgi?action=admineditrankstatus&username=$info{'username'}">Change $mymemsettings[1]'s Rank</A></TD>
  </TR>
~;
}
if ($access[23] eq "on") {
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.impulseoftheshadows.com//cgi-bin/index.cgi?action=admineditaccess&username=$info{'username'}">Change $mymemsettings[1]'s Access</A></TD>
  </TR>
~;
}
...
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="http://www.impulseoftheshadows.com//cgi-bin/index.cgi?action=viewlog&username=$info{'username'}">View $mymemsettings[1]'s Log File</A></TD>
  </TR>
~;
}
...
print qq~
  <TR>
    <TD class="forumwindow1"><img src="http://www.impulseoftheshadows.com//themes/standard/images/dot.gif">&nbsp; &nbsp;<A HREF="javascript:killEntry('index.cgi?action=admindeleteprofile&deleteduser=$info{'username'}')">Delete $mymemsettings[1]</A></TD>
  </TR>
~;
}
print qq~
...
<table border="0">
<tr>
<td class="formstexttitle" colspan="2">Change $mymemsettings[1]'s Rank
</td>
</TR>
...
#  print $test[0];
 ...
 <center><b>$msg{'224'}</b></center><p>
  ...
  foreach (@data) {
     ...
     print qq~<tr>
     <td>$_</td>
     <td>[<a href="$admin&amp;op=deletebannedip&amp;$ip=$_">$nav{'097'}</a>]</td>
      ~;
    }
        print qq ~
