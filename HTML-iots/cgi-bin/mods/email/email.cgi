...
$USER = "webmaster\@mieq.net";
$PASSWORD = "vx1120";
$HOST = "mail.mieq.net";
$DOMAIN = "mieq.net";
$SCRIPTURL = "http://www.mieq.net/cgi-bin/mods/email/email.cgi";
...
<tr><td width=90%></td>
<td>
<table border=0 cellpadding=0 cellspacing=0><tr><td><img src="http://www.mieq.net/images/im/leftoriginal.gif"></td>
<td bgcolor=#D2E2F6 align=center height=6 valign=top><img src=http://www.mieq.net/images/im/toporiginal.gif><br>
<b><a href=$SCRIPTURL?action=send>Write</a></b></td>
<td><img src=http://www.mieq.net/images/im/rightoriginal.gif></td></tr></table>
</td>
</tr>
...
<a href="$SCRIPTURL?action=view&message=$i"><img src="http://www.mieq.net/images/forum/open.gif" alt="View" border="0"></A>
<a href="$SCRIPTURL?action=delete&message=$i"><img src="http://www.mieq.net/images/forum/delete.gif" alt="Delete" border="0"></a>
<a href="$SCRIPTURL?action=reply&to=$returnpath[$i]&message=$i"><img src="http://www.mieq.net/images/forum/replymsg.gif" alt="Reply" border="0"></a>
<a href=$SCRIPTURL?action=forward&message=$i><img src="http://www.mieq.net/images/forum/move.gif" alt="Forward" border="0"></a>
</td></tr>
~;
$shown++;
}#if
...
<TABLE BORDER=0 CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
  <TR>
    <TD>&nbsp; <IMG SRC="http://www.mieq.net/images/im/aicon2.gif"> $subject[$i]</TD>
