...
<tr>
    ...
    <td bgcolor="$dataDarkColor" align="right">
		<a href="$this_cgi?action=print&amp;id=$thisid" target=_new><img src="$imgURL/print.gif" border="0" alt="$office_gen{'020'}" align="absmiddle"></a>&nbsp;
...
print qq~
<form onSubmit="submitonce(this)" action="$this_cgi?action=modify2" method="post" name="creator">
...
print qq~
<center>
<form onSubmit="submitonce(this)" action="$this_cgi?action=add2" method="post" name="creator">
...
print qq~<br>
<form onSubmit="submitonce(this)" action="$this_cgi?action=email_entry2&amp;id=$info{'id'}" method="post">
