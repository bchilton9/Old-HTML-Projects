...
#detect domain name system path
$server_domain="http://$ENV{'SERVER_NAME'}";
$url="$server_domain$ENV{'SCRIPT_NAME'}";
$url=~s /\/setup\.pl//i;
...
#make sure the slahes are correct
$directory=~ tr/\\/\//;
$directory=~s /\/setup\.pl//i;
...
<font face="Arial"><font size="+2">
  Message Board Freeware $version Setup
</font>
<br>
<br>
    ...
    <td>
	  <table border="0" bgcolor="#cccccc" cellspacing="1" cellpadding="1" width="100%">
	    <tr bgcolor="#ffffff">
		  ...
		  <td>
		    <input type="Text" name="domain" value="$server_domain" size="60">
		  </td>
		</tr>
		<tr bgcolor="#f0f0ff">
		  <td>
		  ...
		  <td>
		    <input type="Text" name="cgi" value="$url/message.pl" size="60">
		  </td>
		</tr>
		<tr bgcolor="#ffffff">
		  <td>
		  ...
		  <td>
		    <input type="Text" name="cgi2" value="$url/view.pl" size="60">
		  </td>
		</tr>
		<tr bgcolor="#f0f0ff">
		  <td>
		  ...
		  <td>
		    <input type="Text" name="default_icon" value="$server_domain/[please specify my path]/icons/document.gif" size="60">
		  </td>
		</tr>
		<tr bgcolor="#ffffff">
		  <td>
		  ...
		  <td>
		    <input type="Text" name="email_icon" value="$server_domain/[please specify my path]/icons/email.gif" size="60">
		  </td>
		</tr>
		<tr bgcolor="#f0f0ff">
		  <td>
		  ...
		  <td>
		    <input type="Text" name="cookie_js" value="$server_domain/[please specify my path]/cookie.js" size="60">
		  </td>
		</tr>
	  </table>
	</td>
    ...
    <td>
	  <table border="0" bgcolor="#cccccc" cellspacing="1" cellpadding="1" width="100%">	
		<tr bgcolor="#ffffff">
		  ...
		  <td>
		    <input type="Text" name="bdata" value="$directory/data" size="60">
		  </td>
		</tr>
		<tr bgcolor="#f0f0ff">
		  <td>
		    <b>&nbsp;Logged IP Records</b>
		  </td>
		  <td>
		    <input type="Text" name="misc" value="$directory/misc" size="60">
		  </td>
		</tr>
	  </table>
	</td>
...
<!-- Begin General Formatting ------------------------------------------------->
  ...
  <tr bgcolor="#f0f0ff">
    <td>
	  <font size="1" face="arial" color="#000000">
	   Don't worry about the color settings now. You can modify them later with configur.pl. 
	  </font>
	</td>
  </tr>
  <tr>
    ...
    <td>
	  <table border="0" bgcolor="#cccccc" cellspacing="1" cellpadding="1" width="100%">
	    <tr bgcolor="#ffffff">
		  ...
		  <td>
		    <input type="Text" name="new_icon" value="$server_domain/[please specify my path]/icons/new.gif" size="60">
		  </td>
		</tr>
  ...
  <tr>
    <td>
	  <table border="0" bgcolor="#cccccc" cellspacing="1" cellpadding="1" width="100%">	
			 ...
			 <tr bgcolor="#f0f0ff"><td>Public Board? (This variable is used in Advanced Message Board V4.5x)</td><td><input type=\"text\" name=\"vis\" value=\"1\" size="1">1=Yes (public board).2=No(private board)</td></tr>
     		 <tr bgcolor="#ffffff"><td>Board mode (1=opened: accepts new messages; 2=closed: does not accept any new message): </td><td><input type=\"text\" name=\"mode\" value=\"1\" size="1"></td></tr>
	  ...
	  <tr>
	    <td>
			<input type="hidden" name="admin" value="$request{'admin'}"><input type="hidden" name="password" value="$request{'password'}">
				  <input type="hidden" name="action" value="save"><input type="submit" value="Save settings">
...
print "<br><br><font size=\"+1\"><b>setup.pl should be deleted automatically already. However, you may want to make sure it is deleted.</b><br>";
print "Copyright 1999-2000 CGI-Factory.com of SiliconSoup.com LLC</font>";

unlink "$directory/$setup";
...
<table border="0" bgcolor="#000000" cellspacing="1" cellpadding="0">
  ...
  <tr bgcolor="#7CA3DE">
    <td>
	  <font size="3" face="arial" color="#ffffff">
        <b>Advanced Message Board $version Setup</b>
      </font>
    </td>
  </tr>
  <tr bgcolor="#999999">
...
sub firsttime {
if ($request{'admin_name'} eq "" and !$request{'admin_name'}) {
print "Please don't leave the admin name filed blank!";
exit;
}
...
$request{'admin_name'}=~ tr/A-Z/a-z/; 
$request{'admin_name'}=~ tr/\s//;
$request{'password1'}=~ tr/A-Z/a-z/; 
$password = crypt($request{'password1'}, "YL");	
    
open (PASSWORD, ">$fullpath/$superuser") or &error("unable to create the password file");
if ($flock==1) {
flock PASSWORD, 2; 
}
print PASSWORD "$request{'admin_name'}|$password";
close (PASSWORD);
