	...
	<center>
	 ...
	 <tr>
	  ...
	  <tr><td valign=top>
         ...
         <form name=\"TalkForm\" onSubmit=\"return validate()\" action=\"$url_of_chat_cgi\" method=\"POST\">
...
<CENTER>
Chat Room Closed to save bandwidth!<BR>
Will be opened back up durning Server down times and patches.
...
# height=100%  class=menubackcolor

$users_online .= "<table border=1 cellpadding=1 cellspaceing=1 bgcolor=#ffffff width=80%>
       <tr><th class=cat>$msg_text2</th><th class=cat width=50%>$msg_text7</th></tr>\n";
...
open(FILE, "<$path_to_active_users") || 
 ...
 foreach $cline (@clines){
   ...
   $users_online .= "<tr><td class=cat><font color=\"#$color\">$show_user</font></td>
	  <td><CENTER><font size=-2><font color=\"#$color\">$date</font></font></td></tr>\n";
   $found_users = $found_users + 1;
	  }
close(FILE);

$users_online_header = "<html><head><link rel=stylesheet href=$themesurl/$usertheme/style.css type=text/css> </head>\n<body class=\"menutable\" topmargin=2 leftmargin=2 bottommargin=2 rightmargin=2><CENTER>
       <TABLE WIDTH=100% height=100% class=menutable BORDER=0 CELLPADDING=3 CELLSPACEING=0><TD><TR>$msg_text8<br><br></TR></TD>\n";
  ...
  if($found_users == 0){
	...
	$user_s = "$msg_text11";
     ...
     print "<html><head><title>$msg_text8</title><link rel=stylesheet href=$themesurl/$usertheme/style.css type=text/css> </head>\n<body class=\"menutable\" topmargin=2 leftmargin=2 bottommargin=2 rightmargin=2><CENTER>
	    ...
	    <tr><td colspan=2 class=cat Height=10%><center>$user_s<br>
...
$msg_text21 = &trans_subst($msg_text21,"%idle_timeout%",$timeout);
...
<!-- Begin
function leave() {
window.open('http://www.sanctuaryeq2.com/cgi-bin/mods/chat/chat.cgi?Login=$login&Logout=yes&FA=Logout','','toolbar=no,menubar=no,location=no,height=25,width=100');
}
// End -->
</SCRIPT>
...
<FRAMESET rows="*,60" border=0 onUnload="leave()">
  <FRAMESET cols="80%,*" border=0>
    <FRAMESET ROWS="3%,97%" scrolling=no>
      <FRAME SRC="http://www.sanctuaryeq2.com/blank.html" SCROLLING="No" NORESIZE>
...
# Trying settings
	...
	if(parent.talk.document.TalkForm.Login == null){return;}
      if(parent.talk.document.TalkForm.Login.value == \"$clogin\"){
	document.write(\"<table border=1><tr><td colspan=2 align=center><font size=-1><strong>$msg_text45</strong></td></tr><tr><td width=45%><b>/$msg_text44</b></td><td>$msg_text46</td></tr><tr><td><b>/$msg_text41 &lt;login&gt; &lt;$msg_text47&gt;</B><BR><b>/msg &lt;login&gt; &lt;$msg_text47&gt;</b></td><td>$msg_text48</td></tr><tr><td><b>/$login &lt;$msg_text49&gt;</b><BR><b>/me &lt;$msg_text49&gt;</b></td><td>$msg_text50</td></tr><tr><td><b>/$msg_text23 &lt;$msg_text47&gt;</b></td><td>$msg_text51 \\\"$ucmessagetext\\\"</td></tr>$adm_help_text</font></table>\");
       }
       return;
      }
      </script>\n";
