...
$navbar = "$office_gen{'023'} $username\'s $office_gen{'002'}";
print_top();
...
<tr>
	...
	<!-- calendar table begins -->
		...
		<a href="$officeURL/calendar.cgi">
		<IMG alt="$office_cal{'001'}" src="$imgURL/calendar_small.gif" border="0" align="absmiddle">&nbsp;<b>$office_cal{'001'}</b></A></td>
		</tr>
		...
		<font size="1">~;
		Calendar($dataDarkColor,$dataLightColor,$dataHighlightColor);
		print qq~
		</font></td>
		</tr>
		</table></td>
	...
	<!-- journal table begins -->
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
		<td bgcolor="$dataDarkColor" align="left" valign="middle">
		<a href="$officeURL/journal.cgi">
		<IMG alt="$office_journal{'001'}" src="$imgURL/journal_small.gif" border="0" align="absmiddle">&nbsp;<b>$office_journal{'001'}</b></A></td>
		</tr>
		<tr><td bgcolor="$dataDarkColor">
		<table width="100%" cellpadding="2" cellspacing="1">
		<tr>
	...
	<!-- Tasks table begins -->
		...
		<tr>
		<td bgcolor="$dataDarkColor" align="left" valign="middle">
		<a href="$officeURL/tasks.cgi">
		<IMG alt="$office_task{'001'}" src="$imgURL/task_small.gif" border="0" align="absmiddle">&nbsp;<b>$office_task{'001'}</b></A></td>
		</tr>
		<tr><td bgcolor="$dataDarkColor">
		<table width="100%" cellpadding="2" cellspacing="1">
		<tr>
	...
	<!-- tasks table ends -->
	<P>
	<!-- Contacts table begins -->
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
		<td bgcolor="$dataDarkColor" align="left" valign="middle">
		<a href="$officeURL/contacts.cgi">
		<IMG alt="$office_con{'001'}" src="$imgURL/contact_small.gif" border="0" align="absmiddle">&nbsp;<b>$office_con{'001'}</b></A></td>
		</tr>
		<tr><td bgcolor="$dataDarkColor">
		<table width="100%" cellpadding="2" cellspacing="1">
		<tr>
...
<tr>
	...
	Recent_Journal($dataDarkColor,$dataLightColor);
	print qq~
	</td>
</tr>
<tr>
