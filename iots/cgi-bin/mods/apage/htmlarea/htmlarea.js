...
HTMLArea.Config = function () {
	...
	// URL-s
	this.imgURL = "http://www.YOUR_WEBSITE_HERE.com/images/apage/icons/htmlarea/";
	this.popupURL = "http://www.YOUR_WEBSITE_HERE.com/cgi-bin/mods/apage/htmlarea/popups/";
...
// paths  -- These Were Modified by Weston for Web-APP usage.

HTMLArea.prototype.imgURL = function(file) {
	return this.config.imgURL + file;
};

HTMLArea.prototype.popupURL = function(file) {
	return this.config.popupURL + file;
};
