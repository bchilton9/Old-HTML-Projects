...
<tr>~;
if ($isadmin eq "TRUE") {
print qq~<td bgcolor="#00007D">&nbsp;</td>~;
  }
print qq~<td bgcolor="#00007D"><a href="$cgi?action=memberlist&amp;sort=0"><b>$msg{'013'}</b></a></td>
<td bgcolor="#00007D"><a href="$cgi?action=memberlist&amp;sort=4"><b>$msg{'024'}</b></a></td>
<td bgcolor="#00007D"><b>Lvl:</b></td>
<td bgcolor="#00007D"><b>Class:</b></td>
<td bgcolor="#00007D"><b>Race:</b></td>

<td bgcolor="#00007D"><b>$msg{'031'}</b></td>
<td bgcolor="#00007D"><b>$msg{'027'}</b></td>

<td bgcolor="#00007D" WIDTH="100"></td>
...
<a href="index.cgi?action=anonemail&sendto=$musername" onMouseOver="stm(Text[1],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/email.gif" alt="Send an e-mail to $musername" border="0"></a>

<a href="index.cgi?action=viewprofile&username=$musername" onMouseOver="stm(Text[2],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/profile.gif" alt="View profile of $musername" border="0"></a>

<a href="index.cgi?action=imsend&to=$musername" onMouseOver="stm(Text[3],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/message.gif" alt="Send a message to $musername" border="0"></a>


~;

if ($access[19] eq "on") { print qq~<A HREF="http://www.impulseoftheshadows.com/cgi-bin/index.cgi?action=admineditmember&username=$musername" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/modify.gif" alt="Edit $musername" border=0></A> ~;}
elsif ($access[23] eq "on") { print qq~<A HREF="http://www.impulseoftheshadows.com/cgi-bin/index.cgi?action=admineditmember&username=$musername" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/modify.gif" alt="Edit $musername" border=0></A> ~;}
elsif ($access[25] eq "on") { print qq~<A HREF="http://www.impulseoftheshadows.com/cgi-bin/index.cgi?action=admineditmember&username=$musername" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/modify.gif" alt="Edit $musername" border=0></A> ~;}
elsif ($access[26] eq "on") { print qq~<A HREF="http://www.impulseoftheshadows.com/cgi-bin/index.cgi?action=admineditmember&username=$musername" onMouseOver="stm(Text[4],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/modify.gif" alt="Edit $musername" border=0></A> ~;}

if ($access[21] eq "on") {

if ($musername eq "admin") {
print qq~
<img src="http://www.impulseoftheshadows.com/images/forum/lock.gif" border=0>
~;
}
else {
print qq~
<A HREF="javascript:killEntry('index.cgi?action=admindeleteprofile&deleteduser=$musername')" onMouseOver="stm(Text[5],Style[0])" onMouseOut="htm()"><img src="http://www.impulseoftheshadows.com/images/forum/delete.gif" alt="Delete $musername" border=0></A>
~;
}
