...
print <<"HTML"; 
<META HTTP-EQUIV="Refresh" CONTENT="0;URL=members.cgi?a=main&user=$INPUT{'user'}&pass=$INPUT{'pass'}">
<CENTER><P><BR><P><BR><A HREF="members.cgi?a=main&user=$INPUT{'user'}&pass=$INPUT{'pass'}"><BIG>Please Wait..</B></BIG><P><BR><P><BR></CENTER> 
HTML
 }
