...
<table border='1'>
<tr><td><font size='2'>$msg{'185'}</font></td><td><input type='text' name='nlanguage'></td></tr>
<tr><td><font size='2'>$msg{'186'}</font></td><td><input type='text' name='nfile'></td></tr>
<tr><td><font size='2'>$msg{'187'}</font></td><td><input type='text' name='nstatus'></td></tr>
<tr><td><font size='2'>$msg{'188'}</font></td><td><input type='text' name='nlanggfx'></td></tr>
</table>
<input type='Submit' value='$btn{'019'}'>
</form>
</font>
</font>
";
